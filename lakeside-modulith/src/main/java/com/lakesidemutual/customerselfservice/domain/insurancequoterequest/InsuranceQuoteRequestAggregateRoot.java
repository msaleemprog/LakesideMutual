...
public class InsuranceQuoteRequestAggregateRoot implements RootEntity {
	...
	@ElementCollection
	@CollectionTable(
    	name = "insurance_quote_request_status_history",
    	joinColumns = @JoinColumn(name = "insurance_quote_request_id")
	)	
	@OrderColumn(name = "pos")
	private List<RequestStatusChange> statusHistory = new ArrayList<>();
